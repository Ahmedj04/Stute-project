...
class _ProfileScreen2State extends State<ProfileScreen2> {
  ...
  void pick_image(ImageSource src) async {
    final pickedFile =
        await ImagePicker().pickImage(source: src, imageQuality: 20);
    if (pickedFile != null) {
      setState(() {
  ...
  Future uploadFile(filePath) async {
    ...
    String downloadurl =
        await _storage.ref('userProfile/${useruid}').getDownloadURL();
    return downloadurl;
  }
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              '\n' + snapshot.data['Name'],
                              style: TextStyle(
                                  fontSize: 17, color: Colors.deepPurple[400]),
                            )
                          ],
                        ),
                        SizedBox(
