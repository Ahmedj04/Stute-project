...
class UpdateMyVerify extends StatefulWidget {
  ...
  const UpdateMyVerify({Key? key}) : super(key: key);

  @override
  State<UpdateMyVerify> createState() => _UpdateMyVerifyState();
}

class _UpdateMyVerifyState extends State<UpdateMyVerify> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                "To update your mobile number type in the OTP sent to "+UpdateMyPhone.countryCode.text+UpdateMyPhone.phoneno,
                style: TextStyle(
                  fontSize: 16,
                ),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async{
                      ...
                      try{
                        ...
                        PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: UpdateMyPhone.verify, smsCode: code1+code2+code3+code4+code5+code6);
                        ...
                        Timer(Duration(seconds: 2), () {
                          ...
                          FirebaseFirestore.instance.collection('Users').doc(auth.currentUser!.uid).update(
                              {
                                'Phone Number':UpdateMyPhone.countryCode.text+UpdateMyPhone.phoneno
                              });
                  ...
                  TextButton(
                      onPressed: () {
                        ...
                        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>
                            UpdateMyPhone()), (Route<dynamic> route) => false);
                      },
                      child: Text(
                        "Edit Phone Number ?",
