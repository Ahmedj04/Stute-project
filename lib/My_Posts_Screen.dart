  ...
  Widget build(BuildContext context) {
    return Container(
      child:StreamBuilder<QuerySnapshot>(
          stream:FirebaseFirestore.instance.collection('Posts').orderBy('DateTime',descending: true).where("Parent UID",isEqualTo: user!.uid ).snapshots(),
                              ...
                              children: [
                                if(data['Price']!="")...[
                                  Padding(
                                    ...
                                    child: Text("Price\n"+data['Price'],style: TextStyle(color: Colors.deepPurple[500],fontSize: 13 , fontWeight: FontWeight.w400),),
                                  ),
                                ],
                                if(data['Experience']!="")...[
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Experience\n"+data['Experience'],style: TextStyle(color:Colors.deepPurple[500],fontSize: 13 , fontWeight: FontWeight.w400),),
                                  ),
                                ],
                              ],
                            ),
                            Row(
                              children: [
                                if(data['Teaching Mode']!="")...[
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Teaching Mode\n"+data['Teaching Mode'],style: TextStyle(color: Colors.deepPurple[500],fontSize: 13 , fontWeight: FontWeight.w400),),
                                  ),
                                ],
                              ],
                            ),
